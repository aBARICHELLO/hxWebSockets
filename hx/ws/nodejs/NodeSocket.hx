...
class NodeSocket {
    ...
    public static function select(read: Array<SocketImpl>, write: Array<SocketImpl>, others: Array<SocketImpl>,
            ?timeout: Float): {read: Array<SocketImpl>, write: Array<SocketImpl>, others: Array<SocketImpl>} {
